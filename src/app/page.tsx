  ...
  <div className="bg-[#1F3C3C] text-gray-300 text-xs font-medium">
    <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex justify-between items-center h-10">
      <div className="flex items-center gap-4">
        <a href="mailto:info@mindcare.com" className="flex items-center gap-2 hover:text-white">
      ...
      <div className="flex items-center gap-6">
        ...
        <a href="tel:+1098765432" className="hidden sm:flex items-center gap-2 hover:text-white">
          <Phone className="h-4 w-4" />
